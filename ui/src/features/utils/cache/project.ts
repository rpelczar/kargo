...
import { listProjects } from '@ui/gen/internal/service/v1alpha1/service-KargoService_connectquery';
import { ListProjectsResponseSchema } from '@ui/gen/internal/service/v1alpha1/service_pb';
