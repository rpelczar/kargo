...
import { listAnalysisTemplates } from '@ui/gen/internal/service/v1alpha1/service-KargoService_connectquery';
import { ListAnalysisTemplatesResponseSchema } from '@ui/gen/internal/service/v1alpha1/service_pb';
