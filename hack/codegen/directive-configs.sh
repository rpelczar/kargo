...
out_file=pkg/x/directives/builtins/zz_config_types.go
...
quicktype \
  ...
  --lang go --just-types-and-package --package builtins --omit-empty \
  -o pkg/x/directives/builtins/zz_config_types.go \
