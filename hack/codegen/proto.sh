...
readonly API_PKGS=(
  ...
  "github.com/akuity/kargo/internal/rbac/v1alpha1"
)
...
function main() {
  ...
  set -x
  # IMPORTANT: This doesn't work unless BOTH modules (kargo and kargo/pkg) are
  ...
  cp -R "${build_src_dir}/internal" "${proj_dir}"
